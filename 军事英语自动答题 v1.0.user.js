...
var dict = {
  ...
  "command sergeant major(CSM)/ sergeant major(SGM)": "（美陆军）一级军士长",
  "commander": "（海军）中校",
  "commanding officer": "指挥官；舰长；主官",
  "commissioned officer(CO)": "军官",
  "compile": "收集，搜集（信息，资料）",
  ...
  "nomination": "提名",
  "non-commissioned officer(NCO)": "士官",
  ...
  "sergeant first class(SFC)": "(美陆军)三级军士长",
  "serve": "服役",
  "service": "军种；服役",
  "service cap": "军帽；大檐帽",
  "shipment": "运送",
  ...
  "staff sergeant(SSG)": "（美陆军、海军陆战队）上士；（美空军）中士",
  ...
  "(美陆军)三级军士长": "sergeant first class(SFC)",
  "（飞行）小队；机群": "flight",
  "（固定断骨的）夹板": "splint",
  "（海军）上将": "admiral",
  "（海军）少尉": "ensign",
  "（海军）中将": "vice admiral (VADM)",
  "（海军）中校": "commander",
  ...
  "（美）国防部": "pentagon",
  "（美）太空军士兵": "guardian",
  "（美）太空司令部": "Space Command(SPC)",
  "（美）战争部": "Department of War(DoW)",
  "（美陆军、海军陆战队）上士；（美空军）中士": "staff sergeant(SSG)",
  "（美陆军）二级军士长": ["first sergeant", "master sergeant"],
  "（美陆军）一级军士长": "command sergeant major(CSM)/ sergeant major(SGM)",
  "（枪、炮等的）口径": "caliber",
  ...
  "使遭受;使承受": "inflict",
  "士兵": "enlisted",
  "士官": "non-commissioned officer(NCO)",
  "士气；民心；斗志": "morale",
  ...
  "信号音质": "readability",
  "信号有干扰": "interference",
  "行为准则": ["Code of Conduct", "honor code"],
  "姓名牌": "name plate",
